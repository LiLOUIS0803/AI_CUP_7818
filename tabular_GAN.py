...
df.drop(columns=["unique_id", "player_id", "level",
        "hold racket handed", "play years"], inplace=True)
...
df.to_csv("data/processed/only_gender_train_features_.csv", index=False)
print("多任務補齊資料已儲存至 train_features_augmented.csv")
